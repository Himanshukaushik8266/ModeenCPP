...
void CreateObjects(Container &data)
{
    ...
    // data[0]=(std::make_shared<Car>("c101", 600000.0f, "Dzire", std::make_shared<Engine>(300, 110.0f), CarType::SEDAN));
    // data[1]=(std::make_shared<Car>("c102", 1779000.0f, "Nexon", std::make_shared<Engine>(300, 34500.0f), CarType::SEDAN));
    // data[2]=(std::make_shared<Car>("c103", 7579000.0f, "Creta", std::make_shared<Engine>(9800, 7890.0f), CarType::SUV));
}
