...
void CreateObjects(Container &data, CarContainer &car1, CarContainer &car2, CarContainer &car3)
{
    ...
    data.push_back(std::make_shared<Brand>("Hyundai", std::vector<std::reference_wrapper<Car>>{car1[0], car1[1], car1[2]}));
    ...
    data.push_back(std::make_shared<Brand>("Honda", std::vector<std::reference_wrapper<Car>>{car2[0], car2[1], car2[2]}));
    ...
    data.push_back(std::make_shared<Brand>("Maruti", std::vector<std::reference_wrapper<Car>>{car3[0], car3[1], car3[2]}));
}
